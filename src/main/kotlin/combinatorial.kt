fun <A,B,AC: Iterable<A>> AC.product(bs: Iterable<B>): Sequence<Pair<A,B>> = sequence {
...
fun <A,AC: Iterable<A>> AC.productSelfExcluding(): Sequence<Pair<A,A>> = sequence {
...
fun <A,AC: List<A>> AC.combinations(r: Int): Sequence<List<A>> = sequence {
...
fun <A,AC: List<A>> AC.permutations(r: Int? = null): Sequence<List<A>> = sequence {
